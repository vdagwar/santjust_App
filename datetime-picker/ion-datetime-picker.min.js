        ...
        return {
            ...
            controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function (e, t, n, i) {
                ...
                e.showPopup = function () {
                    t.show({//Seleccionar fecha
                        templateUrl: "lib/ion-datetime-picker/src/picker-popup.html",
                        title: e.title || "Seleccionar " + (e.dateEnabled ? "fecha" : ""),// + (e.dateEnabled && e.timeEnabled ? " and " : "") + (e.timeEnabled ? "a time" : "")
                        subTitle: e.subTitle || "",
                        scope: e,
